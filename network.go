...
type NetworkConfig struct {
	...
	UpperLayer  string `json:"upperLayer,omitempty"` // optional parameter: specify an upper layer for this network i.e. a hierarchy in which this network is a lower layer of another network
}
